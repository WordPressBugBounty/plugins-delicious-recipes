...
class Delicious_Featured_Recipes_Widget extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            'delicious_featured_recipes_widget', // Base ID
            'Delicious: Featured Recipes', // Name
            array(
                'description' => __( "A Featured Recipes Widget for WP Delicious.", 'delicious-recipes'  ),
            ) // Args
        );
    }
    ...
    public function widget( $args, $instance ) {
        ...
        $html = ob_get_clean();
        echo apply_filters( 'wp_delicious_featured_recipe_widget', $html, $args, $instance );
    ...
    public function form( $instance ) {
        $title    = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : __( "Featured Recipes", 'delicious-recipes'  );
...
} // class Delicious_Featured_Recipes_Widget
