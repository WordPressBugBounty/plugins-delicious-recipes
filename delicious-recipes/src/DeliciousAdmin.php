...
class DeliciousAdmin {
	...
	private function init_hooks() {
		...
		/**
		 * Deactivate Clasic Editor Plugin.
		 *
		 * @since 1.6.2
		 */
		...
		/**
		 * Add custom search field by taxonomy in recpe post type.
		 *
		 * @since 1.6.2
		 */
	...
	public function delicious_recipes_classic_editor_plugin_notice() {
		...
		if ( in_array( 'classic-editor/classic-editor.php', $users_activated_plugins ) ) :
	?>
