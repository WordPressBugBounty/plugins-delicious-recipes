...
if ( $enable_poweredby ) : ?>
		...
		<div class="dr-poweredby">
			...
			<a href="<?php echo esc_url( $affiliate_link ); ?>" target="_blank" rel="nofollow noopener sponsored" >
				<img src="<?php echo esc_url( plugin_dir_url( DELICIOUS_RECIPES_PLUGIN_FILE ) ); ?>/assets/images/Delicious-Recipes.png" alt="WP Delicious" width="204" height="30">
			</a>
		</div>
