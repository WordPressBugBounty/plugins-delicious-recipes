		...
		<header class="entry-header">
			...
			<div class="entry-meta">
				...
				<span class="comment">
					...
					<?php // translators: %s: number of comments. ?>
					<span class="meta-text"><?php echo sprintf( esc_html( _nx( '%s Comment', '%s Comments', $recipe->comments_number, 'number of comments', 'delicious-recipes' ) ), esc_html( number_format_i18n( $recipe->comments_number ) ) ); ?></span>
				</span>
