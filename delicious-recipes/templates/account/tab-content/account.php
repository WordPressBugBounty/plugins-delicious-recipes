...
<div class="dr-form__edit-profile-wrapper" id="profile">
	<form class="dr-form__fields-wrapper" method="post">
			...
			<div class="dr-input-wrap">
				<div class="dr-input-upload-file">
					<div id="profile-img" class="dr-profile-img-holder user-male dropzone">
						...
						<input type="hidden" name="profile_image_nonce" value="<?php echo esc_attr( wp_create_nonce( 'delicious-recipes-profile-image-nonce' ) ); ?>">
						<div class="img">
							<?php
							if ( $custom_avatar ) :
		...
		<input type="hidden" name="delicious_recipes_edit_profile_nonce" value="<?php echo esc_attr( wp_create_nonce( 'delicious-recipes-edit-profile-nonce' ) ); ?>" />
