...
`;var Kt=({icon:e,title:t,description:r,...n})=>React.createElement(Jt,n,e&&React.createElement(Ut,null,React.createElement("span",{className:"icon-box-icon"},e)),React.createElement(Qt,null,t&&React.createElement("span",{className:"icon-box-title"},t),r&&React.createElement("span",{className:"icon-box-description"},r)));const Xt=Yt.div`
    display: grid;
...
`;var ir=({options:e,onChange:t,selected:r})=>React.createElement(Xt,null,e.map(e=>{const{id:n,image:i,title:a,description:o}=e;return React.createElement(er,{key:n},React.createElement(tr,{onClick:()=>t(n),isActive:r&&r===n},React.createElement(rr,null,i),React.createElement(nr,null,React.createElement("span",{className:"import-option-title"},a),React.createElement("span",{className:"import-option-description"},o))))}));const ar=Yt.button`
    display: inline-flex;
    align-items: center;
    gap: 4px;
    border: none;
...
`;var lr=({label:e,children:t,prevIcon:r,nextIcon:n,...i})=>React.createElement(ar,i,r&&React.createElement(or,null,r),t||e,n&&React.createElement(or,null,n)),cr=window.wp.components;const sr=Yt.div.attrs(({hasDismissButton:e,status:t,...r})=>r)`
    padding: 16px;
    border-radius: 12px;
...
`;var dr=({status:t,title:r,message:n,onDismiss:i})=>{const a=(0,e.useRef)(null);return React.createElement(sr,{ref:a,status:t,hasDismissButton:i},React.createElement("span",{className:"notification-icon"},React.createElement("svg",{width:"20",height:"20",viewBox:"0 0 20 20",fill:"none",xmlns:"http://www.w3.org/2000/svg"},React.createElement("path",{d:"M9.99979 7.50019V10.8335M9.99979 14.1669H10.0081M8.84589 3.24329L1.99182 15.0821C1.61165 15.7388 1.42156 16.0671 1.44966 16.3366C1.47416 16.5716 1.5973 16.7852 1.78844 16.9242C2.00757 17.0835 2.38695 17.0835 3.14572 17.0835H16.8539C17.6126 17.0835 17.992 17.0835 18.2111 16.9242C18.4023 16.7852 18.5254 16.5716 18.5499 16.3366C18.578 16.0671 18.3879 15.7388 18.0078 15.0821L11.1537 3.24329C10.7749 2.58899 10.5855 2.26184 10.3384 2.15196C10.1228 2.05612 9.87676 2.05612 9.66121 2.15196C9.4141 2.26184 9.2247 2.58899 8.84589 3.24329Z",stroke:"currentColor",strokeWidth:"1.66667",strokeLinecap:"round",strokeLinejoin:"round"}))),React.createElement("span",{className:"notification-msg"},r&&React.createElement(pr,null,r),n||React.createElement(cr.Spinner,{style:{color:"var(--primary-color)"}})),i&&React.createElement(ur,{type:"button",onClick:()=>{a.current.style.opacity="0",setTimeout(()=>{i(!1)},300)}},React.createElement("svg",{width:"20",height:"20",viewBox:"0 0 20 20",fill:"none",xmlns:"http://www.w3.org/2000/svg"},React.createElement("path",{d:"M15 5L5 15M5 5L15 15",stroke:"currentColor",strokeWidth:"1.66667",strokeLinecap:"round",strokeLinejoin:"round"}))))};const mr=Yt.div`
    max-width: 1000px;
    width: 100%;
    margin: 0 auto;
    padding: 0 15px;
`;var hr=({children:e})=>React.createElement(mr,null,e);const fr=Yt.ul`
    display: flex;
...
`;var Rr=({steps:r=[]})=>{const{globalState:n,setGlobalState:i,globalState:{recipesToImport:o,pns:l}}=a(),[c,s]=(0,e.useState)({current:0,completed:[]}),p=(0,e.useRef)(null),u=()=>{p.current.style.cssText="opacity: 0; transform: translateY(20px)",setTimeout(()=>{p.current.style.cssText="opacity: 1; transform: translateY(0px);transition: all .3s ease;"},30)},d=()=>r[c.current].component;return m().createElement("div",null,m().createElement(hr,null,m().createElement(fr,null,r.map(({id:e,label:t},r)=>{const n=c?.current===r,i=c?.completed.includes(r);return m().createElement(gr,{current:n||i},m().createElement(vr,{current:n,completed:i}),t)})),m().createElement(Er,{ref:p},m().createElement(d,null))),c.current<r.length-1&&m().createElement(br,null,m().createElement(hr,null,m().createElement(lr,{variant:"ghost",prevIcon:m().createElement("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg"},m().createElement("path",{d:"M6 8L2 12M2 12L6 16M2 12H22",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"})),onClick:()=>{0!==c.current?(s({...c,current:c.current-1,completed:c.completed.filter(e=>e!==c.current-1)}),u()):i({...n,importStart:!1})}},(0,t.__)("Back","delicious-recipes")),m().createElement(lr,{onClick:()=>{c.current!==r.length-1&&(s({...c,current:c.current+1,completed:[...c.completed,c.current]}),u(),i({...n,pns:c.current+1!==r.length-1}))},disabled:!o.length>0,label:(0,t.__)("Proceed to Next Step","delicious-recipes")}))))};const Cr=Yt.div`
    border: 1px solid #EDEEEE;
    border-radius: 12px;
...
`,Dr=({children:e,...t})=>React.createElement(xr,t,e);Dr.Header=({children:e})=>React.createElement(yr,null,e),Dr.Footer=({children:e})=>React.createElement(wr,null,e),Dr.Length=({value:e,onChange:r})=>{const n=[{value:10,label:(0,t.__)("10","delicious-recipes")},{value:25,label:(0,t.__)("25","delicious-recipes")},{value:50,label:(0,t.__)("50","delicious-recipes")},{value:100,label:(0,t.__)("100","delicious-recipes")},{value:"show-all",label:(0,t.__)("Show All","delicious-recipes")}];return React.createElement(kr,null,React.createElement("label",null,(0,t.__)("Show","delicious-recipes"),React.createElement("select",{onChange:e=>r(e.target.value),value:e,name:"table-length",id:"table-length"},n.map(({value:e,label:t})=>React.createElement("option",{key:`table_length_${e}`,value:e},t))),(0,t.__)("Entries","delicious-recipes")))},Dr.Filter=({value:e,onChange:t})=>React.createElement(Sr,null,React.createElement("label",{htmlFor:"table-filter"},React.createElement("input",{type:"search",name:"import-filter",onChange:e=>t(e),value:e,id:"table-filter",placeholder:"Search"}))),Dr.Info=({length:e,total:r,currentPage:n})=>{if("show-all"===(e=0===r?"show-all":e))return React.createElement(Ir,null,(0,t.__)("Showing","delicious-recipes")," ",r," ",(0,t.__)("entries","delicious-recipes"));const i=(n-1)*e+1,a=Math.min(n*e,r);return React.createElement(Ir,null,(0,t.__)("Showing","delicious-recipes")," ",i," ",(0,t.__)("-","delicious-recipes")," ",a," ",(0,t.__)("of","delicious-recipes")," ",r," ",(0,t.__)("entries","delicious-recipes"))},Dr.Title=({children:e})=>React.createElement(_r,null,e),Dr.Paginate=({length:e,total:t,currentPage:r,setCurrentPage:n})=>{if(0===t)return;if("show-all"===e)return;const i=Math.ceil(t/e),a=Array.from({length:i},(e,t)=>t+1),o=Math.ceil(i/2);let l=!1,c=!1;return React.createElement(Tr,null,React.createElement("ul",null,React.createElement("li",null,React.createElement("a",{href:"#",className:1===r?"disabled":"",onClick:()=>1!==r&&n(r-1)},React.createElement("svg",{width:"20",height:"20",viewBox:"0 0 20 20",fill:"none",xmlns:"http://www.w3.org/2000/svg"},React.createElement("g",null,React.createElement("path",{d:"M15.8334 9.99984H4.16675M4.16675 9.99984L10.0001 15.8332M4.16675 9.99984L10.0001 4.1665",stroke:"currentColor",strokeWidth:"1.67",strokeLinecap:"round",strokeLinejoin:"round"}))))),i>5?a.map((e,t)=>{if(r<o){if((1===r?r+1:r)===e||(2===r?r+1:1)===e||i-1===e||i===e)return React.createElement("li",{key:t},React.createElement("a",{href:"#",className:e===r?"current":"",onClick:()=>n(e)},e));if(!l&&e>r+1&&e<i-1)return l=!0,React.createElement("li",{key:t},React.createElement("a",{href:"#",onClick:e=>e.preventDefault()},"..."))}else if(r>o){if((r===i?r-1:r)===e||(r===i-1?r-1:i)===e||1===e||2===e)return React.createElement("li",{key:t},React.createElement("a",{href:"#",className:e===r?"current":"",onClick:()=>n(e)},e));if(!c&&(3===e||e<r-1))return c=!0,React.createElement("li",{key:t},React.createElement("a",{href:"#",onClick:e=>e.preventDefault()},"..."))}else if(r===o){if(r===e||r-1===e||r+1===e||1===e||i===e)return React.createElement("li",{key:t},React.createElement("a",{href:"#",className:e===r?"current":"",onClick:()=>n(e)},e));if(!l&&e<r-1)return l=!0,React.createElement("li",{key:t},React.createElement("a",{href:"#",onClick:e=>e.preventDefault()},"..."));if(!c&&e>r+1&&e<i)return c=!0,React.createElement("li",{key:t},React.createElement("a",{href:"#",onClick:e=>e.preventDefault()},"..."))}}):a.map((e,t)=>React.createElement("li",{key:t},React.createElement("a",{href:"#",className:e===r?"current":"",onClick:()=>n(e)},e))),React.createElement("li",null,React.createElement("a",{href:"#",className:r===i?"disabled":"",onClick:()=>r!==i&&n(r+1)},React.createElement("svg",{width:"20",height:"20",viewBox:"0 0 20 20",fill:"none",xmlns:"http://www.w3.org/2000/svg"},React.createElement("path",{d:"M4.16675 9.99984H15.8334M15.8334 9.99984L10.0001 4.1665M15.8334 9.99984L10.0001 15.8332",stroke:"currentColor",strokeWidth:"1.67",strokeLinecap:"round",strokeLinejoin:"round"}))))))},Dr.Container=({children:e,...t})=>React.createElement(Cr,t,e),Dr.THead=({children:e,rest:t})=>React.createElement("thead",t,e),Dr.TBody=({children:e,...t})=>React.createElement("tbody",t,e),Dr.TFoot=({children:e,...t})=>React.createElement("tfoot",t,e),Dr.Tr=({items:e,children:t,...r})=>e?e.map(e=>React.createElement("tr",r,e)):React.createElement("tr",r,t),Dr.Th=({items:e,children:t,...r})=>e?e.map(e=>React.createElement("th",r,e)):React.createElement("th",r,t),Dr.Td=({items:e,children:t,...r})=>e?e.map(e=>React.createElement("td",r,e)):React.createElement("td",r,t);var Fr=Dr;function Lr(){return Lr=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var r=arguments[t];for(var n in r)({}).hasOwnProperty.call(r,n)&&(e[n]=r[n])}return e},Lr.apply(null,arguments)}const Pr=Yt.div`
    display: inline-flex;
...
`;var Ur=({progress:e=0})=>(e=Math.floor(e),React.createElement(Yr,null,React.createElement(Jr,null,React.createElement("span",{className:"progressbar-progress",style:{width:`${e}%`}})),e,"%"));const Qr=Yt.div`
    display: flex;
    flex-direction: column;
    gap: 16px;
    overflow: auto;
...
`;var Xr=({items:e=[]})=>(console.log(e),React.createElement(Qr,null,e.map(e=>React.createElement(Kr,{status:e.status},e.name))));const en=Yt.div`
    padding: 32px 24px;
    background-color: #ffffff;
    box-shadow: 0px 4px 12px 0px #1D0D0D0A;
    border-radius: 16px;
