...
`;var dr=t=>{let{status:r,title:n,message:a,onDismiss:i}=t;const o=(0,e.useRef)(null);return React.createElement(sr,{ref:o,status:r,hasDismissButton:i||!1},React.createElement("span",{className:"notification-icon"},React.createElement("svg",{width:"20",height:"20",viewBox:"0 0 20 20",fill:"none",xmlns:"http://www.w3.org/2000/svg"},React.createElement("path",{d:"M9.99979 7.50019V10.8335M9.99979 14.1669H10.0081M8.84589 3.24329L1.99182 15.0821C1.61165 15.7388 1.42156 16.0671 1.44966 16.3366C1.47416 16.5716 1.5973 16.7852 1.78844 16.9242C2.00757 17.0835 2.38695 17.0835 3.14572 17.0835H16.8539C17.6126 17.0835 17.992 17.0835 18.2111 16.9242C18.4023 16.7852 18.5254 16.5716 18.5499 16.3366C18.578 16.0671 18.3879 15.7388 18.0078 15.0821L11.1537 3.24329C10.7749 2.58899 10.5855 2.26184 10.3384 2.15196C10.1228 2.05612 9.87676 2.05612 9.66121 2.15196C9.4141 2.26184 9.2247 2.58899 8.84589 3.24329Z",stroke:"currentColor",strokeWidth:"1.66667",strokeLinecap:"round",strokeLinejoin:"round"}))),React.createElement("span",{className:"notification-msg"},n&&React.createElement(pr,null,n),a||React.createElement(lr.Spinner,{style:{color:"var(--primary-color)"}})),i&&React.createElement(ur,{type:"button",onClick:()=>{o.current.style.opacity="0",setTimeout((()=>{i(!1)}),300)}},React.createElement("svg",{width:"20",height:"20",viewBox:"0 0 20 20",fill:"none",xmlns:"http://www.w3.org/2000/svg"},React.createElement("path",{d:"M15 5L5 15M5 5L15 15",stroke:"currentColor",strokeWidth:"1.66667",strokeLinecap:"round",strokeLinejoin:"round"}))))};const mr=Ut.div`
    max-width: 1000px;
    width: 100%;
    margin: 0 auto;
    padding: 0 15px;
`;var hr=e=>{let{children:t}=e;return React.createElement(mr,null,t)};const fr=Ut.ul`
    display: flex;
...
`;var wr=r=>{let{steps:n=[]}=r;const{globalState:a,setGlobalState:o,globalState:{recipesToImport:c,pns:l}}=i(),[s,p]=(0,e.useState)({current:0,completed:[]}),u=(0,e.useRef)(null),d=()=>{u.current.style.cssText="opacity: 0; transform: translateY(20px)",setTimeout((()=>{u.current.style.cssText="opacity: 1; transform: translateY(0px);transition: all .3s ease;"}),30)},h=()=>n[s.current].component;return m().createElement("div",null,m().createElement(hr,null,m().createElement(fr,null,n.map(((e,t)=>{let{id:r,label:n}=e;const a=s?.current===t,i=s?.completed.includes(t);return m().createElement(gr,{current:a||i},m().createElement(vr,{current:a,completed:i}),n)}))),m().createElement(xr,{ref:u},m().createElement(h,null))),s.current<n.length-1&&m().createElement(hr,null,m().createElement(Er,null,m().createElement(cr,{variant:"ghost",prevIcon:m().createElement("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg"},m().createElement("path",{d:"M6 8L2 12M2 12L6 16M2 12H22",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"})),onClick:()=>{0!==s.current&&(p({...s,current:s.current-1,completed:s.completed.filter((e=>e!==s.current-1))}),d())}},(0,t.__)("Back","delicious-recipes")),m().createElement(cr,{onClick:()=>{s.current!==n.length-1&&(p({...s,current:s.current+1,completed:[...s.completed,s.current]}),d(),o({...a,pns:s.current+1!==n.length-1}))},disabled:!c.length>0,label:(0,t.__)("Proceed to Next Step","delicious-recipes")}))))};const br=Ut.div`
    border: 1px solid #EDEEEE;
    border-radius: 12px;
...
`;var Wr=e=>{let{progress:t=0}=e;return t=Math.floor(t),React.createElement(zr,null,React.createElement(Vr,null,React.createElement("span",{className:"progressbar-progress",style:{width:`${t}%`}})),t,"%")};const Zr=Ut.div`
    display: flex;
    flex-direction: column;
    gap: 16px;
    overflow: auto;
...
`;var Yr=e=>{let{items:t=[]}=e;return React.createElement(Zr,null,t.map((e=>React.createElement(Gr,{status:e.status},e.name))))};const Ur=Ut.div`
    padding: 32px 24px;
    background-color: #ffffff;
    box-shadow: 0px 4px 12px 0px #1D0D0D0A;
    border-radius: 16px;
...
`,nn=Ut.h2`
    ...
    margin: 0 0 32px;
    text-align: center;
`,an=[{id:"cooked",image:React.createElement("img",{src:`${Xr}/assets/images/import-recipes/cooked.png`}),title:(0,t.__)("Cooked"),description:(0,t.__)("Import all recipes from Cooked plugin.")},{id:"wp-recipe-maker",image:React.createElement("img",{src:`${Xr}/assets/images/import-recipes/wp-recipe-maker.png`}),title:(0,t.__)("WP Recipe Maker"),description:(0,t.__)("Import all recipes from WP Recipe Maker plugin.")}];var on=()=>{const{globalState:r,setGlobalState:n,globalState:{importStart:a,selectedOption:o,recipeCount:l,list:p}}=i(),[u,d]=(0,e.useState)("");(0,e.useEffect)((()=>{o&&m(o)}),[o]);const m=function(){var e=c((function*(e){n({...r,loading:!0});const[t,a]=yield Promise.all([s()({path:`/deliciousrecipe/v1/get_import_plugin_terms?selectedOption=${e}`}),s()({path:`/deliciousrecipe/v1/get_import_recipes?selectedOption=${e}`})]);a.success?n({...r,importPluginFields:t?.data||[],recipes:a?.data||[],recipeCount:a?.data?.length||0,recipesToList:a?.data?.slice(0,p)||[],loading:!1}):(d(a.data),n({...r,importPluginFields:[],recipes:[],recipeCount:0,recipesToList:[],loading:!1}))}));return function(_x){return e.apply(this,arguments)}}();return React.createElement(tn,null,a?React.createElement(hr,null,React.createElement(nn,null,(0,t.__)("Import Recipes","delicious-recipes")),React.createElement(wr,{steps:[{id:"recipes-import",label:(0,t.__)("Recipes to Import","delicious-recipes"),component:React.createElement(Ar,null)},{id:"fields-mapping",label:(0,t.__)("Fields Mapping","delicious-recipes"),component:React.createElement($r,null)},{id:"summary",label:(0,t.__)("Summary","delicious-recipes"),component:React.createElement(Hr,null)},{id:"import-process",label:(0,t.__)("Import Process","delicious-recipes"),component:React.createElement(Qr,null)}]})):React.createElement(hr,null,React.createElement(en,{starter:!0},React.createElement(Qt,{icon:React.createElement("svg",{width:"25",height:"25",viewBox:"0 0 25 25",fill:"none",xmlns:"http://www.w3.org/2000/svg"},React.createElement("path",{d:"M24.6519 2.82855L21.8928 0.301686C21.6981 0.124223 21.3786 0 21.1158 0H5.91263C5.50735 0 5.17996 0.328305 5.17996 0.734497V4.31332H1.27206C0.57095 4.31332 0 4.88514 0 5.58858V8.61777C0 9.32121 0.57095 9.89303 1.27206 9.89303H5.17996V24.265C5.17996 24.6712 5.50735 25 5.91263 25H24.2673C24.6726 25 25 24.6712 25 24.265V3.62072C25 3.34171 24.8575 3.01686 24.6519 2.82855ZM1.27206 8.95692C1.0852 8.95692 0.932847 8.80459 0.932847 8.61777V5.58858C0.932847 5.40126 1.0852 5.24894 1.27206 5.24894H5.17996H6.11232H8.08648C8.48979 5.24894 8.81915 4.91916 8.81915 4.51444V3.16179C8.86451 3.17362 8.9153 3.19925 8.96164 3.24608L9.91322 4.20043L10.8466 5.13556L12.5703 6.86385C12.6339 6.92793 12.6703 7.01321 12.6703 7.10293C12.6703 7.19363 12.6339 7.27891 12.5703 7.343L11.7981 8.11644L11.3322 8.58424L10.8663 9.05206L8.96263 10.9603C8.91727 11.0071 8.86747 11.0308 8.82014 11.0416V9.69191C8.82014 9.28719 8.49078 8.95692 8.08747 8.95692H6.1133H5.18095H1.27206ZM24.0667 24.0644H6.11182V9.89254H7.88581V11.1565C7.88581 11.504 8.12543 11.9038 8.52727 11.9698C8.59679 11.9822 8.6668 11.9876 8.73829 11.9876C9.07258 11.9876 9.38566 11.8579 9.62134 11.6213L12.1827 9.05156H21.2538V8.11594H13.1156L13.2275 8.00404C13.4691 7.76348 13.6022 7.44257 13.6022 7.10194C13.6022 6.76131 13.4691 6.44139 13.2295 6.20083L12.165 5.13507H21.2538V4.19994H11.2331L9.62282 2.58602C9.33685 2.29715 8.92664 2.16751 8.52677 2.23455C8.12543 2.30109 7.88532 2.70088 7.88532 3.04791V4.31332H6.11133V0.935128H21.1128C21.1523 0.936114 21.2361 0.969634 21.2642 0.99231L24.0183 3.51474C24.0376 3.53692 24.0637 3.59657 24.0667 3.62072V24.0644Z",fill:"currentColor"}),React.createElement("path",{d:"M21.253 12.0317H8.92583V12.9674H21.253V12.0317Z",fill:"currentColor"}),React.createElement("path",{d:"M21.253 15.9478H8.92583V16.8829H21.253V15.9478Z",fill:"currentColor"}),React.createElement("path",{d:"M21.253 19.8633H8.92583V20.7989H21.253V19.8633Z",fill:"currentColor"})),title:(0,t.__)("Import Recipes","delicious-recipes"),description:(0,t.__)("Select from the options below to import your recipes.","delicious-recipes")}),React.createElement(ar,{options:an,selected:o,onChange:e=>n({...r,selectedOption:e})}),o&&l>0&&React.createElement(dr,{key:"warning",status:"warning",message:(0,t.__)("We recommend taking a full backup of your site before proceeding with the import. Alternatively, you can also create a staging site and import the recipes.","delicious-recipes")}),o&&l<1&&React.createElement(dr,{key:"error",status:"error",message:u}),React.createElement(rn,null,React.createElement(cr,{type:"button",disabled:!o||l<1,label:(0,t.__)("Proceed to Next Step","delicious-recipes"),onClick:()=>n({...r,importStart:!0})})))))};const{pluginUrl:cn}=dr_import||{};var ln=e=>{let{pageTitle:t}=e;return React.createElement("header",{className:"wpdelicious-setting-header border-bottom-1 top-2 flex items-center gap-1"},React.createElement("div",{className:"wpdelicious-logo"},React.createElement("img",{src:cn?`${cn}/assets/images/Delicious-Recipes.png`:""})),t&&React.createElement("span",{className:"dr-page-name"},t))};let sn=document.getElementById("delicious-recipe-import"),pn=sn.dataset.restNonce;(0,e.createRoot)(sn).render(React.createElement(a,null,React.createElement(ln,null),React.createElement(on,{rest_nonce:pn})))}(),(drExports=void 0===drExports?{}:drExports).import={}}();