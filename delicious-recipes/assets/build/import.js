...
`;var ti=({icon:e,title:t,description:i,...r})=>React.createElement(Kt,r,e&&React.createElement(Xt,null,React.createElement("span",{className:"icon-box-icon"},e)),React.createElement(ei,null,t&&React.createElement("span",{className:"icon-box-title"},t),i&&React.createElement("span",{className:"icon-box-description"},i)));const ii=Qt.div`
    display: grid;
...
`;var li=({options:e,onChange:t,selected:i})=>React.createElement(ii,null,e.map(e=>{const{id:r,image:n,title:o,description:a}=e;return React.createElement(ri,{key:r},React.createElement(ni,{onClick:()=>t(r),isActive:i&&i===r},React.createElement(oi,null,n),React.createElement(ai,null,React.createElement("span",{className:"import-option-title"},o),React.createElement("span",{className:"import-option-description"},a))))}));const si=Qt.button`
    display: inline-flex;
    align-items: center;
    gap: 4px;
    border: none;
...
`;var pi=({label:e,children:t,prevIcon:i,nextIcon:r,...n})=>React.createElement(si,n,i&&React.createElement(ci,null,i),t||e,r&&React.createElement(ci,null,r)),ui=window.wp.components;const di=Qt.div.attrs(({hasDismissButton:e,status:t,...i})=>i)`
    padding: 16px;
    border-radius: 12px;
...
`;var fi=({status:e,title:i,message:r,onDismiss:n})=>{const o=(0,t.useRef)(null);return React.createElement(di,{ref:o,status:e,hasDismissButton:n},React.createElement("span",{className:"notification-icon"},React.createElement("svg",{width:"20",height:"20",viewBox:"0 0 20 20",fill:"none",xmlns:"http://www.w3.org/2000/svg"},React.createElement("path",{d:"M9.99979 7.50019V10.8335M9.99979 14.1669H10.0081M8.84589 3.24329L1.99182 15.0821C1.61165 15.7388 1.42156 16.0671 1.44966 16.3366C1.47416 16.5716 1.5973 16.7852 1.78844 16.9242C2.00757 17.0835 2.38695 17.0835 3.14572 17.0835H16.8539C17.6126 17.0835 17.992 17.0835 18.2111 16.9242C18.4023 16.7852 18.5254 16.5716 18.5499 16.3366C18.578 16.0671 18.3879 15.7388 18.0078 15.0821L11.1537 3.24329C10.7749 2.58899 10.5855 2.26184 10.3384 2.15196C10.1228 2.05612 9.87676 2.05612 9.66121 2.15196C9.4141 2.26184 9.2247 2.58899 8.84589 3.24329Z",stroke:"currentColor",strokeWidth:"1.66667",strokeLinecap:"round",strokeLinejoin:"round"}))),React.createElement("span",{className:"notification-msg"},i&&React.createElement(mi,null,i),r||React.createElement(ui.Spinner,{style:{color:"var(--primary-color)"}})),n&&React.createElement(hi,{type:"button",onClick:()=>{o.current.style.opacity="0",setTimeout(()=>{n(!1)},300)}},React.createElement("svg",{width:"20",height:"20",viewBox:"0 0 20 20",fill:"none",xmlns:"http://www.w3.org/2000/svg"},React.createElement("path",{d:"M15 5L5 15M5 5L15 15",stroke:"currentColor",strokeWidth:"1.66667",strokeLinecap:"round",strokeLinejoin:"round"}))))};const gi=Qt.div`
    max-width: 1000px;
    width: 100%;
    margin: 0 auto;
    padding: 0 15px;
`;var bi=({children:e})=>React.createElement(gi,null,e);const vi=Qt.ul`
    display: flex;
...
`;var _i=({steps:e=[]})=>{const{globalState:r,setGlobalState:n,globalState:{recipesToImport:a,pns:l}}=o(),[s,c]=(0,t.useState)({current:0,completed:[]}),p=(0,t.useRef)(null),d=()=>{p.current.style.cssText="opacity: 0; transform: translateY(20px)",setTimeout(()=>{p.current.style.cssText="opacity: 1; transform: translateY(0px);transition: all .3s ease;"},30)},m=()=>e[s.current].component;return u().createElement("div",null,u().createElement(bi,null,u().createElement(vi,null,e.map(({id:e,label:t},i)=>{const r=s?.current===i,n=s?.completed.includes(i);return u().createElement(Ei,{current:r||n},u().createElement(Ci,{current:r,completed:n}),t)})),u().createElement(xi,{ref:p},u().createElement(m,null))),s.current<e.length-1&&u().createElement(Ri,null,u().createElement(bi,null,u().createElement(pi,{variant:"ghost",prevIcon:u().createElement("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg"},u().createElement("path",{d:"M6 8L2 12M2 12L6 16M2 12H22",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"})),onClick:()=>{0!==s.current?(c({...s,current:s.current-1,completed:s.completed.filter(e=>e!==s.current-1)}),d()):n({...r,importStart:!1})}},(0,i.__)("Back","delicious-recipes")),u().createElement(pi,{onClick:()=>{s.current!==e.length-1&&(c({...s,current:s.current+1,completed:[...s.completed,s.current]}),d(),n({...r,pns:s.current+1!==e.length-1}))},disabled:!a.length>0,label:(0,i.__)("Proceed to Next Step","delicious-recipes")}))))};const wi=Qt.div`
    border: 1px solid #EDEEEE;
    border-radius: 12px;
...
`,Li=({children:e,...t})=>React.createElement(ki,t,e);Li.Header=({children:e})=>React.createElement(Si,null,e),Li.Footer=({children:e})=>React.createElement(Ti,null,e),Li.Length=({value:e,onChange:t})=>{const r=[{value:10,label:(0,i.__)("10","delicious-recipes")},{value:25,label:(0,i.__)("25","delicious-recipes")},{value:50,label:(0,i.__)("50","delicious-recipes")},{value:100,label:(0,i.__)("100","delicious-recipes")},{value:"show-all",label:(0,i.__)("Show All","delicious-recipes")}];return React.createElement(Fi,null,React.createElement("label",null,(0,i.__)("Show","delicious-recipes"),React.createElement("select",{onChange:e=>t(e.target.value),value:e,name:"table-length",id:"table-length"},r.map(({value:e,label:t})=>React.createElement("option",{key:`table_length_${e}`,value:e},t))),(0,i.__)("Entries","delicious-recipes")))},Li.Filter=({value:e,onChange:t})=>React.createElement(Ii,null,React.createElement("label",{htmlFor:"table-filter"},React.createElement("input",{type:"search",name:"import-filter",onChange:e=>t(e),value:e,id:"table-filter",placeholder:"Search"}))),Li.Info=({length:e,total:t,currentPage:r})=>{if("show-all"===(e=0===t?"show-all":e))return React.createElement(Di,null,(0,i.__)("Showing","delicious-recipes")," ",t," ",(0,i.__)("entries","delicious-recipes"));const n=(r-1)*e+1,o=Math.min(r*e,t);return React.createElement(Di,null,(0,i.__)("Showing","delicious-recipes")," ",n," ",(0,i.__)("-","delicious-recipes")," ",o," ",(0,i.__)("of","delicious-recipes")," ",t," ",(0,i.__)("entries","delicious-recipes"))},Li.Title=({children:e})=>React.createElement(yi,null,e),Li.Paginate=({length:e,total:t,currentPage:i,setCurrentPage:r})=>{if(0===t)return;if("show-all"===e)return;const n=Math.ceil(t/e),o=Array.from({length:n},(e,t)=>t+1),a=Math.ceil(n/2);let l=!1,s=!1;return React.createElement(Ni,null,React.createElement("ul",null,React.createElement("li",null,React.createElement("a",{href:"#",className:1===i?"disabled":"",onClick:()=>1!==i&&r(i-1)},React.createElement("svg",{width:"20",height:"20",viewBox:"0 0 20 20",fill:"none",xmlns:"http://www.w3.org/2000/svg"},React.createElement("g",null,React.createElement("path",{d:"M15.8334 9.99984H4.16675M4.16675 9.99984L10.0001 15.8332M4.16675 9.99984L10.0001 4.1665",stroke:"currentColor",strokeWidth:"1.67",strokeLinecap:"round",strokeLinejoin:"round"}))))),n>5?o.map((e,t)=>{if(i<a){if((1===i?i+1:i)===e||(2===i?i+1:1)===e||n-1===e||n===e)return React.createElement("li",{key:t},React.createElement("a",{href:"#",className:e===i?"current":"",onClick:()=>r(e)},e));if(!l&&e>i+1&&e<n-1)return l=!0,React.createElement("li",{key:t},React.createElement("a",{href:"#",onClick:e=>e.preventDefault()},"..."))}else if(i>a){if((i===n?i-1:i)===e||(i===n-1?i-1:n)===e||1===e||2===e)return React.createElement("li",{key:t},React.createElement("a",{href:"#",className:e===i?"current":"",onClick:()=>r(e)},e));if(!s&&(3===e||e<i-1))return s=!0,React.createElement("li",{key:t},React.createElement("a",{href:"#",onClick:e=>e.preventDefault()},"..."))}else if(i===a){if(i===e||i-1===e||i+1===e||1===e||n===e)return React.createElement("li",{key:t},React.createElement("a",{href:"#",className:e===i?"current":"",onClick:()=>r(e)},e));if(!l&&e<i-1)return l=!0,React.createElement("li",{key:t},React.createElement("a",{href:"#",onClick:e=>e.preventDefault()},"..."));if(!s&&e>i+1&&e<n)return s=!0,React.createElement("li",{key:t},React.createElement("a",{href:"#",onClick:e=>e.preventDefault()},"..."))}}):o.map((e,t)=>React.createElement("li",{key:t},React.createElement("a",{href:"#",className:e===i?"current":"",onClick:()=>r(e)},e))),React.createElement("li",null,React.createElement("a",{href:"#",className:i===n?"disabled":"",onClick:()=>i!==n&&r(i+1)},React.createElement("svg",{width:"20",height:"20",viewBox:"0 0 20 20",fill:"none",xmlns:"http://www.w3.org/2000/svg"},React.createElement("path",{d:"M4.16675 9.99984H15.8334M15.8334 9.99984L10.0001 4.1665M15.8334 9.99984L10.0001 15.8332",stroke:"currentColor",strokeWidth:"1.67",strokeLinecap:"round",strokeLinejoin:"round"}))))))},Li.Container=({children:e,...t})=>React.createElement(wi,t,e),Li.THead=({children:e,rest:t})=>React.createElement("thead",t,e),Li.TBody=({children:e,...t})=>React.createElement("tbody",t,e),Li.TFoot=({children:e,...t})=>React.createElement("tfoot",t,e),Li.Tr=({items:e,children:t,...i})=>e?e.map(e=>React.createElement("tr",i,e)):React.createElement("tr",i,t),Li.Th=({items:e,children:t,...i})=>e?e.map(e=>React.createElement("th",i,e)):React.createElement("th",i,t),Li.Td=({items:e,children:t,...i})=>e?e.map(e=>React.createElement("td",i,e)):React.createElement("td",i,t);var Pi=Li;function Vi(){return Vi=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var i=arguments[t];for(var r in i)({}).hasOwnProperty.call(i,r)&&(e[r]=i[r])}return e},Vi.apply(null,arguments)}const Mi=Qt.div`
    display: inline-flex;
...
`,$i=e=>React.createElement(Mi,{bulk:e?.bulk},React.createElement("input",Vi({type:"checkbox"},e)));$i.Bulk=e=>React.createElement($i,Vi({bulk:!0},e));var Ai=$i,Bi=()=>{const{globalState:e,setGlobalState:r,globalState:{recipes:n,selectedOption:a,recipeCount:l,recipesToList:s,list:c,currentPage:p,recipesToImport:u,deleteRecipes:d}}=o(),[m,h]=(0,t.useState)({selectedRecipes:u,localInput:"",debouncedInput:"",filteredRecipes:s,filteredRecipeList:c,filteredRecipeCount:l}),{selectedRecipes:f,localInput:g,debouncedInput:b,filteredRecipes:v,filteredRecipeList:E,filteredRecipeCount:C}=m;let R="";return"cooked"===a?R="Cooked":"wp-recipe-maker"===a&&(R="WP Recipe Maker"),(0,t.useEffect)(()=>{const e=setTimeout(()=>{h({...m,debouncedInput:g})},500);return()=>{clearTimeout(e)}},[g]),(0,t.useEffect)(()=>{let e=s,t=c,i=l;b&&(e=n.filter(e=>e.post_title.toLowerCase().includes(b.toLowerCase())),t=e.length>0||g.length>0?"show-all":c,i=e.length>0?e.length:g.length>0?0:i),h({...m,filteredRecipes:e,filteredRecipeList:t,filteredRecipeCount:i})},[b]),React.createElement(React.Fragment,null,React.createElement(Pi.Container,null,React.createElement(Pi.Header,null,React.createElement(Pi.Length,{value:E,onChange:t=>{h({...m,filteredRecipeList:t,filteredRecipes:"show-all"===t?n:n.slice(0,t)}),r({...e,currentPage:1,list:t,recipesToList:"show-all"===t?n:n.slice(0,t),recipesToImport:[]})}}),React.createElement(Pi.Filter,{value:g,onChange:e=>{h({...m,localInput:e.target.value})}})),React.createElement(Pi,{striped:!0,bordered:!0},React.createElement(Pi.THead,null,React.createElement(Pi.Tr,null,React.createElement(Pi.Th,null,React.createElement(Ai.Bulk,{checked:u.length===v.length,onChange:t=>{r({...e,recipesToImport:t.target.checked?v.map(e=>({id:e.ID,post_title:e.post_title,thumbnail_url:e.thumbnail_url,author:e.author,post_date:e.post_date,post_status:e.post_status})):[]})}})),React.createElement(Pi.Th,{style:{width:"135px"}},(0,i.__)("Featured Image")),React.createElement(Pi.Th,null,(0,i.__)("Recipe Title")),React.createElement(Pi.Th,null,(0,i.__)("Author")),React.createElement(Pi.Th,null,(0,i.__)("Date Published")))),React.createElement(Pi.TBody,null,""!==g&&0===v.length&&React.createElement(Pi.Tr,null,React.createElement(Pi.Td,{colSpan:"5"},React.createElement(fi,{status:"error",message:(0,i.__)("No recipes found.","delicious-recipes")}))),f?.map((t,i)=>{const o=n.find(e=>e.ID===t.id);return React.createElement(Pi.Tr,{key:i},React.createElement(Pi.Td,null,React.createElement(Ai,{checked:f.some(e=>e.id===o.ID),onChange:t=>{r({...e,recipesToImport:t.target.checked?[...f,{id:o.ID,post_title:o.post_title,thumbnail_url:o.thumbnail_url,author:o.author,post_date:o.post_date,post_status:o.post_status}]:f.filter(e=>e.id!==o.ID)})}})),React.createElement(Pi.Td,null,o.thumbnail_url&&React.createElement("img",{className:"import-recipe-image",src:o.thumbnail_url,alt:o.post_title})),React.createElement(Pi.Td,null,React.createElement("strong",null,o.post_title),"publish"!==o.post_status&&React.createElement("span",{className:" wpd-ml-1 dr-badge"},o.post_status)),React.createElement(Pi.Td,null,o.author),React.createElement(Pi.Td,null,o.post_date))}),f.length>0&&React.createElement(Pi.Tr,null,React.createElement(Pi.Td,{colSpan:"5"},React.createElement(fi,{message:(0,i.__)("Selected recipes listed above.","delicious-recipes")}))),v?.filter(e=>!f.some(t=>t.id===e.ID)).map((t,i)=>React.createElement(Pi.Tr,{key:i},React.createElement(Pi.Td,null,React.createElement(Ai,{checked:u.some(e=>e.id===t.ID),onChange:i=>{r({...e,recipesToImport:i.target.checked?[...u,{id:t.ID,post_title:t.post_title,thumbnail_url:t.thumbnail_url,author:t.author,post_date:t.post_date,post_status:t.post_status}]:u.filter(e=>e.id!==t.ID)})}})),React.createElement(Pi.Td,null,t.thumbnail_url&&React.createElement("img",{className:"import-recipe-image",src:t.thumbnail_url,alt:t.post_title})),React.createElement(Pi.Td,null,React.createElement("strong",null,t.post_title),"publish"!==t.post_status&&React.createElement("span",{className:" wpd-ml-1 dr-badge"},t.post_status)),React.createElement(Pi.Td,null,t.author),React.createElement(Pi.Td,null,t.post_date))))),React.createElement(Pi.Footer,null,React.createElement(Pi.Info,{length:E,total:C,currentPage:p}),React.createElement(Pi.Paginate,{length:E,total:C,currentPage:p,setCurrentPage:t=>{r({...e,currentPage:t,recipesToImport:[],recipesToList:n.slice((t-1)*E,t*E)})}}))),React.createElement("label",null,React.createElement(Ai,{checked:d,onChange:t=>{r({...e,deleteRecipes:!!t.target.checked})}}),(0,i.__)("Delete the recipes from ","delicious-recipes"),React.createElement("strong",null,R),(0,i.__)(" after a successful import.","delicious-recipes")))},Oi=({children:e,onClick:t,label:i,description:r,small:n})=>{const o=n?" small":"";return React.createElement("div",{className:`wpdelicious-dropzone-container${o}`},React.createElement("div",{className:"wpdelicious-dropzone",onClick:t},React.createElement("span",{className:"upload-icon"},React.createElement("svg",{width:"36",height:"36",viewBox:"0 0 36 36",fill:"none",xmlns:"http://www.w3.org/2000/svg"},React.createElement("path",{d:"M11.9999 24L17.9999 18M17.9999 18L23.9999 24M17.9999 18V31.5M29.9999 25.1143C31.8322 23.6011 32.9999 21.3119 32.9999 18.75C32.9999 14.1937 29.3063 10.5 24.7499 10.5C24.4222 10.5 24.1155 10.329 23.9491 10.0466C21.993 6.72725 18.3816 4.5 14.2499 4.5C8.03674 4.5 2.99994 9.5368 2.99994 15.75C2.99994 18.8492 4.25311 21.6556 6.28036 23.6903",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"}))),i&&React.createElement("label",null,i),!n&&r&&React.createElement("span",{className:"wpdelicious-supported-files"},r)),e)};const Hi=Qt.span`
    display: block;
    font-size: 18px;
    line-height: 1.5;
    font-weight: 500;
...
`;var Yi=()=>{const{globalState:{recipes:e,recipeFields:r,recipesToImport:n},wpd_fields:a}=o(),[l,s]=(0,t.useState)(!1);return React.createElement(qi,null,React.createElement(Ji,null,(0,i.__)("Recipes to Import")),React.createElement(Pi.Container,null,React.createElement(Pi,{bordered:!0,striped:!0},React.createElement(Pi.THead,null,React.createElement(Pi.Tr,null,React.createElement(Pi.Th,null,"Featured Image"),React.createElement(Pi.Th,null,"Recipe Title"))),React.createElement(Pi.TBody,null,n?.slice(0,l?n.length:3).map((t,i)=>{const r=e.find(e=>e.ID===t.id);return React.createElement(Pi.Tr,{key:i},React.createElement(Pi.Td,null,r.thumbnail_url&&React.createElement("img",{className:"import-recipe-image",src:r.thumbnail_url,alt:r.post_title})),React.createElement(Pi.Td,null,React.createElement("strong",null,r.post_title)))})),n?.length>3&&!l&&React.createElement(Pi.TFoot,null,React.createElement(Pi.Tr,null,React.createElement(Pi.Td,{colSpan:"2",style:{textAlign:"center"}},React.createElement(pi,{label:"View All",variant:"ghost",onClick:()=>{s(!0)},nextIcon:React.createElement("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg"},React.createElement("path",{d:"M6 9L12 15L18 9",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"}))})))),l&&React.createElement(Pi.TFoot,null,React.createElement(Pi.Tr,null,React.createElement(Pi.Td,{colSpan:"2",style:{textAlign:"center"}},React.createElement(pi,{label:"View Less",variant:"ghost",onClick:()=>s(!1),nextIcon:React.createElement("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg"},React.createElement("path",{d:"M6 15L12 9L18 15",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"}))})))))),React.createElement(Ui,null,React.createElement(Ji,null,(0,i.__)("Fields Mapped:","delicious-recipes")),Object.keys(r)?.map((e,t)=>r[e]?React.createElement("ul",{key:t},React.createElement("li",null,React.createElement("span",{className:"label"},a[e],":"),React.createElement("span",{className:"value"},r[e]))):null)))};const Qi=Qt.div`
    display: flex;
    align-items: center;
    gap: 12px;
    font-size: 14px;
...
`;var Xi=({progress:e=0})=>(e=Math.floor(e),React.createElement(Qi,null,React.createElement(Ki,null,React.createElement("span",{className:"progressbar-progress",style:{width:`${e}%`}})),e,"%"));const er=Qt.div`
    display: flex;
    flex-direction: column;
    gap: 16px;
    overflow: auto;
...
`;var ir=({items:e=[]})=>(console.log(e),React.createElement(er,null,e.map(e=>React.createElement(tr,{status:e.status},e.name))));const rr=Qt.div`
    padding: 32px 24px;
    background-color: #ffffff;
    box-shadow: 0px 4px 12px 0px #1D0D0D0A;
    border-radius: 16px;
...
`,dr=Qt.h2`
    ...
    margin: 0 0 32px;
    text-align: center;
`,mr=[{id:"cooked",image:React.createElement("img",{src:`${sr}/assets/images/import-recipes/cooked.png`}),title:(0,i.__)("Cooked"),description:(0,i.__)("Import all recipes from Cooked plugin.")},{id:"wp-recipe-maker",image:React.createElement("img",{src:`${sr}/assets/images/import-recipes/wp-recipe-maker.png`}),title:(0,i.__)("WP Recipe Maker"),description:(0,i.__)("Import all recipes from WP Recipe Maker plugin.")},{id:"csv",image:React.createElement("img",{src:`${sr}/assets/images/import-recipes/csv-import.png`}),title:(0,i.__)("CSV Import"),description:(0,i.__)("Import recipes from CSV file.")},{id:"tasty-recipes",image:React.createElement("img",{src:`${sr}/assets/images/import-recipes/tasty-recipes.jpg`}),title:(0,i.__)("Tasty Recipes"),description:(0,i.__)("Import all recipes from Tasty Recipes plugin.")}];var hr=()=>{const{globalState:e,setGlobalState:r,globalState:{importStart:n,selectedOption:a,recipeCount:s,list:p,isCSV:u}}=o(),[d,m]=(0,t.useState)("");(0,t.useEffect)(()=>{a&&!u&&h(a)},[a]);const h=function(){var t=l(function*(t){r({...e,loading:!0});const[i,n]=yield Promise.all([c()({path:`/deliciousrecipe/v1/get_import_plugin_terms?selectedOption=${t}`}),c()({path:`/deliciousrecipe/v1/get_import_recipes?selectedOption=${t}`})]);n.success?r({...e,importPluginFields:i?.data||[],recipes:n?.data||[],recipeCount:n?.data?.length||0,recipesToList:n?.data?.slice(0,p)||[],loading:!1}):m(n.data)});return function(_x){return t.apply(this,arguments)}}(),f=u||a&&s>0,g=a&&s<1&&!u;return React.createElement(pr,null,n?React.createElement(bi,null,React.createElement(dr,null,(0,i.__)("Import Recipes","delicious-recipes")),React.createElement(_i,{steps:[{id:"recipes-import",label:u?(0,i.__)("CSV File Upload","delicious-recipes"):(0,i.__)("Recipes to Import","delicious-recipes"),component:u?React.createElement(Wi,null):React.createElement(Bi,null)},{id:"fields-mapping",label:(0,i.__)("Fields Mapping","delicious-recipes"),component:React.createElement(Zi,null)},...u?[]:[{id:"summary",label:(0,i.__)("Summary","delicious-recipes"),component:React.createElement(Yi,null)}],{id:"import-process",label:(0,i.__)("Import Process","delicious-recipes"),component:React.createElement(lr,null)}]})):React.createElement(bi,null,React.createElement(cr,{starter:!0},React.createElement(ti,{icon:React.createElement("svg",{width:"25",height:"25",viewBox:"0 0 25 25",fill:"none",xmlns:"http://www.w3.org/2000/svg"},React.createElement("path",{d:"M24.6519 2.82855L21.8928 0.301686C21.6981 0.124223 21.3786 0 21.1158 0H5.91263C5.50735 0 5.17996 0.328305 5.17996 0.734497V4.31332H1.27206C0.57095 4.31332 0 4.88514 0 5.58858V8.61777C0 9.32121 0.57095 9.89303 1.27206 9.89303H5.17996V24.265C5.17996 24.6712 5.50735 25 5.91263 25H24.2673C24.6726 25 25 24.6712 25 24.265V3.62072C25 3.34171 24.8575 3.01686 24.6519 2.82855ZM1.27206 8.95692C1.0852 8.95692 0.932847 8.80459 0.932847 8.61777V5.58858C0.932847 5.40126 1.0852 5.24894 1.27206 5.24894H5.17996H6.11232H8.08648C8.48979 5.24894 8.81915 4.91916 8.81915 4.51444V3.16179C8.86451 3.17362 8.9153 3.19925 8.96164 3.24608L9.91322 4.20043L10.8466 5.13556L12.5703 6.86385C12.6339 6.92793 12.6703 7.01321 12.6703 7.10293C12.6703 7.19363 12.6339 7.27891 12.5703 7.343L11.7981 8.11644L11.3322 8.58424L10.8663 9.05206L8.96263 10.9603C8.91727 11.0071 8.86747 11.0308 8.82014 11.0416V9.69191C8.82014 9.28719 8.49078 8.95692 8.08747 8.95692H6.1133H5.18095H1.27206ZM24.0667 24.0644H6.11182V9.89254H7.88581V11.1565C7.88581 11.504 8.12543 11.9038 8.52727 11.9698C8.59679 11.9822 8.6668 11.9876 8.73829 11.9876C9.07258 11.9876 9.38566 11.8579 9.62134 11.6213L12.1827 9.05156H21.2538V8.11594H13.1156L13.2275 8.00404C13.4691 7.76348 13.6022 7.44257 13.6022 7.10194C13.6022 6.76131 13.4691 6.44139 13.2295 6.20083L12.165 5.13507H21.2538V4.19994H11.2331L9.62282 2.58602C9.33685 2.29715 8.92664 2.16751 8.52677 2.23455C8.12543 2.30109 7.88532 2.70088 7.88532 3.04791V4.31332H6.11133V0.935128H21.1128C21.1523 0.936114 21.2361 0.969634 21.2642 0.99231L24.0183 3.51474C24.0376 3.53692 24.0637 3.59657 24.0667 3.62072V24.0644Z",fill:"currentColor"}),React.createElement("path",{d:"M21.253 12.0317H8.92583V12.9674H21.253V12.0317Z",fill:"currentColor"}),React.createElement("path",{d:"M21.253 15.9478H8.92583V16.8829H21.253V15.9478Z",fill:"currentColor"}),React.createElement("path",{d:"M21.253 19.8633H8.92583V20.7989H21.253V19.8633Z",fill:"currentColor"})),title:(0,i.__)("Import Recipes","delicious-recipes"),description:(0,i.__)("Select from the options below to import your recipes.","delicious-recipes")}),React.createElement(li,{options:mr,selected:a,onChange:t=>r({...e,selectedOption:t,isCSV:"csv"===t})}),f&&React.createElement(fi,{key:"warning",onDismiss:()=>r({...e,showMsg:!1}),status:"warning",message:(0,i.__)("We recommend taking a full backup of your site before proceeding with the import. Alternatively, you can also create a staging site and import the recipes.","delicious-recipes")}),g&&React.createElement(fi,{key:"error",status:"error",message:d}),React.createElement(ur,null,React.createElement(pi,{type:"button",disabled:!(u||a&&s>=1),label:(0,i.__)("Proceed to Next Step","delicious-recipes"),onClick:()=>r({...e,importStart:!0})})))))};const{pluginUrl:fr}=dr_import||{};var gr=({pageTitle:e})=>React.createElement("header",{className:"wpdelicious-setting-header border-bottom-1 top-2 flex items-center gap-1"},React.createElement("div",{className:"wpdelicious-logo"},React.createElement("img",{src:fr?`${fr}assets/images/Delicious-Recipes.png`:""})),e&&React.createElement("span",{className:"dr-page-name"},e));let br=document.getElementById("delicious-recipe-import"),vr=br.dataset.restNonce;(0,t.createRoot)(br).render(React.createElement(n,null,React.createElement(gr,null),React.createElement(hr,{rest_nonce:vr}))),(drExports=void 0===drExports?{}:drExports).import={}}();